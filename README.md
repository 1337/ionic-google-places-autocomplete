...
Install via bower: `bower install ionic-google-places-autocomplete`
...
<script src="/bower_components/ionic-google-places-autocomplete/src/autocomplete.js"></script>
```

You'll probably also want the styles:

```html
<link rel="stylesheet" href="/bower_components/ionic-google-places-autocomplete/src/autocomplete.css">
```
